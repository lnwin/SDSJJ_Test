...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        progressBar->setGeometry(QRect(470, 680, 691, 21));
        ...
        openGLWidget->setGeometry(QRect(650, 0, 640, 480));
        ...
        widget->setGeometry(QRect(10, 660, 431, 111));
        label_9 = new QLabel(widget);
        label_9->setObjectName(QString::fromUtf8("label_9"));
        label_9->setGeometry(QRect(9, 9, 66, 16));
        ...
        CameraBrightness->setGeometry(QRect(81, 9, 101, 22));
        ...
        Brightness_spinBoxdouble = new QDoubleSpinBox(widget);
        ...
        Brightness_spinBoxdouble->setGeometry(QRect(190, 10, 48, 20));
        ...
        Cameragain_spinBoxdouble->setGeometry(QRect(190, 40, 41, 20));
